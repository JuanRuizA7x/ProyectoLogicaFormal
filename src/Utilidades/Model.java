 ...
 * fixes the <b>truth value</b> - <em>true</em> or <em>false</em> - for every
 * proposition symbol.<br>
 * <br>
 * Models as implemented here can represent partial assignments to the set of
 * proposition symbols in a Knowledge Base (i.e. a partial model).
 *
 * @author Ravi Mohan
...
public class Model {
     ...
     * assignments. false, if the clause is known to be false under the model's
     * assignments. null, if it is unknown whether the clause is true or false
     * under the model's current assignments.
     */
